...
class IridiumBasicNode(Node):
    ...
    def send_at(self, cmd: str, read_bytes: int = 512) -> str:
        ...
        Your modem echoes commands, so responses may look like:
        AT+CSQ
        +CSQ: 3
        OK
        """
    ...
    def mt_message_present(self, response: str) -> bool:
        ...
        We just check whether mt_len > 0 or mt_queued > 0.
        """
    ...
    def poll_modem(self):
        try:
            ...
            # 3) Run SBD session to check/send/receive
